...
class TestCiclistaServiceConsultar(unittest.TestCase):
    ...
    def setUp(self):
        ...
        ciclista_mock1 = MagicMock(nome="Arthur", nascimento="27/03/2002", cpf="122323", passaporte=None,
                                   nacionalidade="Brasileiro", email="arthur.andre", urlFotoDocumento="https", id=1, senha="12356", cadastro=None)
        ciclista_mock2 = MagicMock(nome="Arthur André", nascimento="27/03/2002", cpf="122323", passaporte=None,
                                   nacionalidade="Estrangeiro", email="arthur.andre", urlFotoDocumento="https", id=2, senha="12356", cadastro=None)
