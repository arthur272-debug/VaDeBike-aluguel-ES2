...
class TestAlugarBicicleta(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.contador = 1
        ciclista = Ciclista.Ciclista(nome="Arthur",nascimento="27/03/2002",cpf="122323",passaporte=None,nacionalidade="Brasileiro",email="arthur.andre",urlFotoDocumento="https",id=self.contador,senha="12356",cadastro=None,cartao=None,aluguel=None)
    ...
    def test_alugar_bicicleta_ciclista_nao_encontrado(self):
        ...
        aluguel_dto_invalido = MagicMock(ciclista=1000,trancaInicio=1234,bicicleta=1,horaInicio=0,trancaFim=0,horaFim=0,cobranca=0)
    ...
    def test_alugar_bicicleta_sucesso(self):
         # Chame a função alugar_bicicleta
        aluguel_dto_valido = MagicMock(ciclista=self.contador,trancaInicio=1234,bicicleta=1,horaInicio=0,trancaFim=0,horaFim=0,cobranca=0)
    ...
    def test_alugar_bicicleta_sucesso_alugada(self):
        # Chame a função alugar_bicicleta
        aluguel_dto_valido = MagicMock(ciclista=1,trancaInicio=1234,bicicleta=1,horaInicio=0,trancaFim=0,horaFim=0,cobranca=0)
