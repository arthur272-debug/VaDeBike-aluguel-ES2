...
class TestCiclistaServiceCadastro(unittest.TestCase):
    ...
    def test_cadastrarCiclista(self):
        ...
        ciclista_mock = MagicMock(nome="Arthur",nascimento="27/03/2002",cpf="122323",passaporte=None,nacionalidade="Brasileiro",email="arthur.andre",urlFotoDocumento="https",id=0,senha="12356",cadastro=None)
        resultado = CiclistaService.CiclistaService.cadastrar_ciclista(ciclista_mock)
