...
class TestCiclistaServiceConsultarEmail(unittest.TestCase):
    ...
    def setUp(self):
        ...
        ciclista_mock2 = MagicMock(nome="Arthur André",nascimento="27/03/2002",cpf="122323",passaporte=None,nacionalidade="Estrangeiro",email="arthurandre@gmail.com",urlFotoDocumento="https",id=2,senha="12356",cadastro=None)
    ...
    def test_consultar_ciclistaEmail_existente(self):
        ...
        resultado = CiclistaService.CiclistaService.consultar_ciclista_email("arthur.andre@gmail.com")
