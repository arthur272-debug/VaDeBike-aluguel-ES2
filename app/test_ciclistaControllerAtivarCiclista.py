...
class TestCiclistaRouteAtivacao(unittest.TestCase):
    ...
    def test_realizar_ativacao_ciclista_sucesso(self):
        ...
        ciclista_mock = MagicMock(email = "art.andre@gmail.com",nacionalidade = Nacionalidade.BRASILEIRA,nascimento="27/03/2022",nome="Tutu",senha="1234567",cpf="123456",numero="1235767",validade="23/09",pais="Brasil",urlFotoDocumento="endereco.url",cadastro=RespostaCadastro.CONFIRMACAO,id=1)
