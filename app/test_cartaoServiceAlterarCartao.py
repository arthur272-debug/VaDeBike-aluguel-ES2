...
class TestCartaoServiceAlterar(unittest.TestCase):
    ...
    def test_alterar_cartao_sucesso(self):
        ...
        id_ciclista = 1
        cartao_dto = MagicMock(nomeTitular="Novo Titular",
                               numero="4444333322221111", validade="06/24", cvv="456")

        # Chame a função alterar_cartao
        resultado = CartaoService.CartaoService.alterar_cartao(
    ...
    def test_alterar_cartao_ciclista_nao_encontrado(self):
        ...
        # Chame a função alterar_cartao
        resultado = CartaoService.CartaoService.alterar_cartao(
            id_ciclista_invalido, cartao_dto)
