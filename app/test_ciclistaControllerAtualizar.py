...
class TestCiclistaRouteAtualizacao(unittest.TestCase):
    ...
    def test_realizar_atualizacao_ciclista_sucesso(self):
        ...
        ciclista_mock = MagicMock(email="art.andre@gmail.com", nacionalidade=Nacionalidade.BRASILEIRA, nascimento="27/03/2022", nome="Tutu", senha="1234567",
                                  cpf="123456", numero="1235767", validade="23/09", pais="Brasil", urlFotoDocumento="endereco.url", cadastro=RespostaCadastro.ATIVO, id=1)
        ...
        resposta = self.client.put(
            '/ciclista/1', json=dados_atualizacao_validos)
    ...
    def test_realizar_atualizacao_ciclista_nao_encontrado(self):
        ...
        resposta = self.client.put(
            '/ciclista/999', json=dados_atualizacao_invalidos)
