...
class CiclistaService:
    ...
    @staticmethod
    def cadastrar_ciclista(ciclista_dto):  # fazer a validacao de cartao
        ...
        ciclista = Ciclista.Ciclista(ciclista_dto.nome, ciclista_dto.nascimento, ciclista_dto.cpf, ciclista_dto.passaporte, ciclista_dto.nacionalidade,
                                     ciclista_dto.email, ciclista_dto.urlFotoDocumento, ciclista_dto.id, ciclista_dto.senha, ciclista_dto.cadastro, ciclista_dto.cartao, ciclista_dto.aluguel)
