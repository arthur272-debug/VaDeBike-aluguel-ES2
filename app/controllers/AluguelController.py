...
def realizar_devolucao():
    ...
    devolucao = AluguelService.AluguelService.devolver_bicicleta(devolucao_dados['idBicicleta'],devolucao_dados['idTranca'])

    if devolucao is not None:
        informacoes_devolucao = {"bicicleta":devolucao.bicicleta,"horaInicio":devolucao.horaInicio,"trancaFim":devolucao.trancaFim,"horaFim":devolucao.horaFim,"cobranca":devolucao.cobranca,"ciclista":devolucao.ciclista,"trancaInicio":devolucao.trancaInicio}
