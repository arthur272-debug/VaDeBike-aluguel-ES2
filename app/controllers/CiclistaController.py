...
def realizar_cadastro():
   ...
   cartao = CartaoDTO.CartaoDto(ciclista_dados["nomeTitular"],ciclista_dados["numero_cartao"],ciclista_dados["validade_cartao"],ciclista_dados["cvv"],len(CiclistaService.CiclistaService.Ciclista)+1) 
